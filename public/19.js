...
/***/ "./resources/js/src/containers/Backend/Admin/Cities/Actions/Add.js":
/*!*************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Admin/Cities/Actions/Add.js ***!
  \*************************************************************************/
...
var Add = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Add, [{
    ...
    value: function render() {
      ...
      var companies = this.props.backend.cities.companies;
      var countries = [];
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onSubmit: function onSubmit(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_7__["postCities"](data));
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/Admin/Cities/Actions/Edit.js":
/*!**************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Admin/Cities/Actions/Edit.js ***!
  \**************************************************************************/
/*! exports provided: default */
...
var Edit = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Edit, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.city && prevState.name === '') return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_11__["updateObject"])(prevState, _objectSpread({}, nextProps.city));
      return prevState;
    }
  }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    submit: function submit(id, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_10__["patchCities"](id, data));
    }
  };
};
...
/***/ "./resources/js/src/containers/Backend/Admin/Cities/Actions/View.js":
/*!**************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Admin/Cities/Actions/View.js ***!
  \**************************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref2) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], {
    ...
    className: "mr-2",
    fixedWidth: true
  }), "City details"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Company"
  }, city.company), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Country"
  }, city.country), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Name"
  }, city.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(I, {
    label: "Creation Date"
  }, Object(_shared_utility__WEBPACK_IMPORTED_MODULE_4__["convertDate"])(city.created_at))));
});

/***/ }),

/***/ "./resources/js/src/containers/Backend/Admin/Cities/index.js":
/*!*******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/Admin/Cities/index.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _Actions_Edit__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Actions/Edit */ "./resources/js/src/containers/Backend/Admin/Cities/Actions/Edit.js");
/* harmony import */ var _Actions_Add__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./Actions/Add */ "./resources/js/src/containers/Backend/Admin/Cities/Actions/Add.js");
/* harmony import */ var _Actions_View__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./Actions/View */ "./resources/js/src/containers/Backend/Admin/Cities/Actions/View.js");
...
var Index = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props$backend$c = this.props.backend.cities,
      ...
      if (loading) content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Col"], {
        ...
        if (cities) {
          ...
          var data = cities.map(function (city) {
            ...
            return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_21__["updateObject"])(city, {
              created_at: Object(_shared_utility__WEBPACK_IMPORTED_MODULE_21__["convertDate"])(city.created_at),
              action: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
                ...
                deleteAction: function deleteAction() {
                  return _this.props["delete"](city.id);
                }
              }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        user: true
      }, "Cities")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "p-4 pb-0"
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_20__["getCities"]());
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_20__["deleteCities"](id));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_20__["patchCities"](id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_20__["citiesReset"]());
    }
  };
};
