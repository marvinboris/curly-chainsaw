...
/***/ "./resources/js/src/containers/Backend/User/AttendanceReport/index.js":
/*!****************************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/AttendanceReport/index.js ***!
  \****************************************************************************/
...
var Index = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      var _this$props$backend$a = this.props.backend.attendanceReport,
          loading = _this$props$backend$a.loading,
          error = _this$props$backend$a.error,
          message = _this$props$backend$a.message,
          attendanceReport = _this$props$backend$a.attendanceReport,
          weeks = _this$props$backend$a.weeks;
      var content;
      var errors;
      var feedback;
        ...
        if (attendanceReport) {
          ...
          var weeksData = weeks.map(function (week, index) {
            return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Col"], {
              ...
              className: "h-100 p-3 bg-white shadow-sm d-flex flex-column"
            }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
              ...
              className: "mr-2 bg-" + cardColors[index]
              ...
              className: "text-soft text-700 text-large"
            }, Object(_shared_utility__WEBPACK_IMPORTED_MODULE_18__["timeFromTimestamp"])(week.time)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
              className: "text-300"
            }, "Hours")))));
          });
          var attendanceReportData = attendanceReport.map(function (day) {
            return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_18__["updateObject"])(day, {
              clock_in_date: Object(_shared_utility__WEBPACK_IMPORTED_MODULE_18__["convertDate"])(day.clock_in),
              clock_out_date: Object(_shared_utility__WEBPACK_IMPORTED_MODULE_18__["convertDate"])(day.clock_out),
              time: Object(_shared_utility__WEBPACK_IMPORTED_MODULE_18__["timeFromTimestamp"])(day.time),
              clock_in_time: Object(_shared_utility__WEBPACK_IMPORTED_MODULE_18__["convertTime"])(day.clock_in),
              clock_out_time: Object(_shared_utility__WEBPACK_IMPORTED_MODULE_18__["convertTime"])(day.clock_out),
          ...
          }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"][new Date().getMonth()])), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "p-3"
          }, new Date().getFullYear())), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], {
            className: "py-5"
          }, weeksData), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_3__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Backend_UI_List_List__WEBPACK_IMPORTED_MODULE_9__["default"], {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        user: true
      }, "Attendance Report")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "p-4 pb-0"
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onGetAttendanceReport: function onGetAttendanceReport() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__["getAttendanceReport"]());
    },
    onPostTaskDelete: function onPostTaskDelete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__["postTaskDelete"](id));
    },
    onPostTaskUpdate: function onPostTaskUpdate(id, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__["postTaskUpdate"](id, data));
    },
    onResetAttendanceReport: function onResetAttendanceReport() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__["resetAttendanceReport"]());
    }
  };
};
