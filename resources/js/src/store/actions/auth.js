...
const authUserLoginSuccess = (token, data) => ({ type: actionTypes.AUTH_USER_LOGIN_SUCCESS, token, data: { ...data } });
const authAdminVerifySuccess = (token, data) => ({ type: actionTypes.AUTH_ADMIN_VERIFY_SUCCESS, token, data: { ...data } });
