...
class Index extends Component {
    ...
    render() {
        let { backend: { employees: { loading, error, message, attendanceReport, weeks } } } = this.props;
            ...
            if (attendanceReport) {
                ...
                content = (
                    <>
                        ...
                        <Row>
                            <List array={attendanceReportData} data={JSON.stringify(attendanceReport)} bordered icon={faClock} title="Employee Details" className="bg-white shadow-sm"
                                fields={[
        ...
        return (
            <>
                <div className="bg-white py-4 pl-5 pr-4 position-relative">
                    <Breadcrumb items={[{ to: '/admin/employees', content: 'Employees' }]} main="Employee Details" icon={faClock} />
                    <SpecialTitle user icon={faClock}>Admin panel</SpecialTitle>
                    <Subtitle user>Employee Details</Subtitle>
                </div>
...
const mapDispatchToProps = dispatch => ({
    get: id => dispatch(actions.getEmployee(id)),
