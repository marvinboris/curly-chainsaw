        ...
        if (loading) content = <Col xs={12}>
            ...
            if (messages) {
                ...
                content = (
                    <>
                        <Row>
                            <List array={messagesData} data={JSON.stringify(messages)} bordered add="New Message" link="/user/messages/add" icon={faEnvelope} title="All Messages" className="bg-white shadow-sm"
                                fields={[
        ...
        return (
            <>
                <div className="bg-white py-4 pl-5 pr-4 position-relative">
                    <Breadcrumb main="All Messages" icon={faEnvelope} />
                    <SpecialTitle user icon={faEnvelope}>Employee panel</SpecialTitle>
                    <Subtitle user>All Messages</Subtitle>
                </div>
