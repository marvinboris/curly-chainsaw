        ...
        if (loading) content = <Col xs={12}>
            ...
            if (messages) {
                ...
                content = (
                    <>
                        <Row>
                            <List array={messagesData} data={JSON.stringify(messages)} bordered add="New Message" link="/user/messages/add" icon={faEnvelope} title="Archived Messages" className="bg-white shadow-sm"
                                fields={[
...
const mapDispatchToProps = dispatch => ({
    onGetMessages: () => dispatch(actions.getArchiveMessages()),
