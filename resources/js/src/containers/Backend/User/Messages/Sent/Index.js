        ...
        if (loading) content = <Col xs={12}>
            ...
            if (messages) {
                ...
                content = (
                    <>
                        <Row>
                            <List array={messagesData} data={JSON.stringify(messages)} bordered add="New Message" link="/user/messages/add" icon={faEnvelope} title="Sent Messages" className="bg-white shadow-sm"
                                fields={[
        ...
        return (
            <>
                <div className="bg-white py-4 pl-5 pr-4 position-relative">
                    <Breadcrumb main="Sent Messages" icon={faEnvelope} />
                    <SpecialTitle user icon={faEnvelope}>Employee panel</SpecialTitle>
                    <Subtitle user>Sent Messages</Subtitle>
                </div>
...
const mapDispatchToProps = dispatch => ({
    onGetMessages: () => dispatch(actions.getSentMessages()),
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(Sent));